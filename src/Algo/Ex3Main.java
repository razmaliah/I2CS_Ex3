 ...
 * 4. Your are asked to implement the following classes: Algo.Index2D, Algo.Map, Algo.Ex3Algo.
...
public class Ex3Main {
    ...
    public static void play1() {
        ...
        while(ex3.getStatus()!=PacmanGame.DONE) {
            ...
            if (_cmd != null && _cmd == 'h') {
            	System.out.println("Pacman help: keys: ' '-start, 'w,a,x,d'-directions, all other parameters should be configured via Algo.GameInfo.java, ");
            }
